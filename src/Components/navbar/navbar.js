...
const navbar = () => {
  return (
    <div class="row mt-sm-5 ">
      <div class="col-sm-12 shad p-3 mb-5 bg-white bordrup">
        <div class="row slider">
          <div class="col text-center">
            <a class="links-icons" href="Mydetailsbiolege2.html">
              <button class="icons1">
                <svg
                  aria-hidden="true"
                  focusable="false"
              ...
              <div class="icons-text">My details</div>
            </a>
          </div>
          <div class="col text-center">
            <a class="links-icons" href="SuvangiMyTestsDoneRuchikaRe.html">
              <button class="icons">
                <svg
                  aria-hidden="true"
                  focusable="false"
          ...
          <div class="col text-center">
            <a class="links-icons" href="index.html">
              <button class="icons">
                <svg
                  aria-hidden="true"
                  focusable="false"
            ...
            <a class="links-icons" href="#">
              <button class="icons">
                <svg
                  ...
                  class="svg-inline--fa fa-briefcase-medical fa-w-16"
                  role="img"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
                >
              ...
              <div class="icons-text">Medicine</div>
            </a>
          </div>
          <div class="col text-center">
            <a class="links-icons" href="bhuswarnabiolegenavs.html">
              <button class="icons">
                <svg
                  aria-hidden="true"
                  focusable="false"
              ...
              <div class="icons-text">Notifications</div>
            </a>
          </div>
          <div class="col text-center">
            <a class="links-icons" href="Payment.html">
              <button class="icons">
                <svg
                  aria-hidden="true"
                  focusable="false"
                  ...
                  class="svg-inline--fa fa-money-check fa-w-20"
                  role="img"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 640 512"
                >
              ...
              <div class="icons-text">Payment</div>
            </a>
          </div>
          <div class="col text-center">
            <a class="links-icons" href="Membership1.html">
              <button class="icons">
                <svg
                  aria-hidden="true"
                  focusable="false"
              ...
              <div class="icons-text ">Membership</div>
            </a>
          </div>
          <div class="col text-center">
            <a class="links-icons" href="reckon4.html">
              <button class="icons">
                <svg
                  aria-hidden="true"
                  focusable="false"
              ...
              <div class="icons-text ">My family</div>
            </a>
          </div>
        </div>
      </div>

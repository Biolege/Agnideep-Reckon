...
const medicalEdu = () => {
  return (
    <div class="my-5 mx-2">
      <div>
        <h6 class="mb-3">Medical education</h6>
        ...
        <div class="ml-4">
              ...
              <div class="modal-content m-2">
                ...
                <div class="modal-body">
                  <form action="">
                    ...
                    <div class="d-flex justify-content-between">
                      <div class="form-group">
                        <label for="cn">Degree name</label>
                        <input type="text" class="form-control" id="cn" />
                      </div>
                      <div class="form-group">
                        <label for="rn">Field of study</label>
                        <input type="text" class="form-control" id="rn" />
                      </div>
                    </div>
                  </form>
          ...
          <h6>
            <li>Degree name - college name - Year of pass out</li>
          </h6>
        </div>
      </div>
    </div>
